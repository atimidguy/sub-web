...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "dmc-sub.vercel.app (Provided by @atimidguy）": "https://dmc-sub.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://dmc-sub.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://dmc-sub.vercel.app/sub?";
